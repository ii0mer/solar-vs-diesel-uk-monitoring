...
from .monte_carlo import SITE_DESIGN, run_monte_carlo, summarise
...
def main():
    ...
    N['worst_case'] = combined_worst_case(SITE_DESIGN).to_dict(orient='records')
    ...
    N['degradation_designs'] = {'0.3': [400, 1.0], '0.5': [450, 1.0], '0.8': [450, 1.0]}
