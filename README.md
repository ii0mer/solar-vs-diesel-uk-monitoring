...
## Headline results (v1.1 model, regenerated by `python -m src.make_all`)

Design criterion: LOLP <= 1% in the governing year (year 24: modules at 89.1% of year-1 output, battery at 80% state of health), explicit loss chain (12.7% incl. MPPT) plus incidence-angle losses, lifetime-NPV ranking.

| Site | PV (Wp) | Battery (kWh) | LOLP yr 1 (%) | LOLP yr 24 (%) | Solar LCOE 5% (£/kWh) | Ratio A2 5% | Ratio A2 8% |
|---|---|---|---|---|---|---|---|
| Southampton | 500 | 1.00 | 0.148 | 0.753 | 5.899 | 3.72 | 3.44 |
| Birmingham | 550 | 1.25 | 0.571 | 0.993 | 6.178 | 3.55 | 3.27 |
| Liverpool | 650 | 1.25 | 0.354 | 0.982 | 6.427 | 3.41 | 3.12 |
| Edinburgh | 650 | 1.50 | 0.320 | 0.868 | 6.581 | 3.33 | 3.04 |

Diesel A2 (battery-buffered, 12 visits/yr) LCOE: £21.938/kWh at 5%; A1 (continuous) £58.27/kWh.
Visit-cadence sensitivity (5%): 12/6/4/2 visits/yr -> Southampton 3.72/2.13/1.60/1.07x; break-even 1.7-2.2 visits/yr.
Monte Carlo (5,000 draws, monthly attendance): ratio P50 3.45-3.84x at 5%; no draw below parity.
Battery break-even: £12,289-18,856/kWh at 5%.
Combined worst case (monthly attendance): 1.65-2.00x.
...
Yes, conditional on the diesel plant being attended monthly. Solar-battery is **3.33–3.72× cheaper** than battery-buffered diesel at the central assumptions and **1.65–2.00× cheaper** under the combined worst case; the advantage rests on the visit differential (85% of diesel lifetime cost is site visits, 2.3% fuel) and reaches parity only at about two diesel visits a year.
...
- *Architecture 1:* Continuous 24/7 — 1 kW genset at 1.5% rated load, 769 L/year (worst case)
- *Architecture 2:* Intermittent + battery — runtime derived from the daily energy balance (1.46 h/day at 30% load), Skarstein–Uhlen fuel 84 L/year (realistic, central case)
